...
//
//public class CreateAdapter extends RecyclerView.Adapter<RandomRecipeViewHolder> {
//    Context context;
//    List<String> list;
...
//        return new CreateViewHolder(LayoutInflater.from(context).inflate(R.layout.list_random_recipe, parent, false));
//    }
//
//    @Override
